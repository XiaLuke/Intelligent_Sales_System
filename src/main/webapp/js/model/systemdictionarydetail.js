$(function () {
    ...
    //1.获取常用的一些组件
    var systemdictionarydetailGrid = $("#systemdictionarydetailGrid");
    ...
    itsource={
	    ...
	    */
        ...
        del(){
            ...
            $.messager.confirm('确认','您确认想要删除记录吗？',function(r){
                if (r){
                    ...
                    $.get("/systemdictionarydetail/delete",{id:row.id},function (result) {
        ...
        search(){
            ...
            systemdictionarydetailGrid.datagrid("load",params);
        },
        //关闭窗口
        closeDialog(){
