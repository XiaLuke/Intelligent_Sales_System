...
<%--
    pagination:分页条支持
--%>
<table id="supplierGrid" class="easyui-datagrid"
       data-options="url:'/supplier/page',fitColumns:true,singleSelect:true,fit:true,pagination:true,toolbar:'#gridTools'">
    <thead>
    <tr>
