...
<%--
    pagination:分页条支持
--%>
<table id="producttypeGrid" class="easyui-datagrid"
       data-options="url:'/producttype/page',fitColumns:true,singleSelect:true,fit:true,pagination:true,toolbar:'#gridTools'">
    <thead>
    <tr>
    ...
    <form id="editForm" method="post">
        ...
        <table cellpadding="5">
                ...
                <td><input class="easyui-validatebox" type="text" name="descs"
                        ...
                        <tr>
                <td>parentId:</td>
                <td><input class="easyui-validatebox" type="text" name="parentId"
                           data-options="required:true"></input></td>
            </tr>
                    </table>
    </form>
