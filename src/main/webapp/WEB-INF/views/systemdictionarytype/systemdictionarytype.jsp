...
<%--
    pagination:分页条支持
--%>
<table id="systemdictionarytypeGrid" class="easyui-datagrid"
       data-options="url:'/systemdictionarytype/page',fitColumns:true,singleSelect:true,fit:true,pagination:true,toolbar:'#gridTools'">
    <thead>
    <tr>
