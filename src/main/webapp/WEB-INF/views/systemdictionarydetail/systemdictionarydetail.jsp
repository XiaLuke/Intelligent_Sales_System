...
<table id="systemdictionarydetailGrid" class="easyui-datagrid"
       data-options="url:'/systemdictionarydetail/page',fitColumns:true,singleSelect:true,fit:true,pagination:true,toolbar:'#gridTools'">
    <thead>
    <tr>
    ...
    <form id="editForm" method="post">
        ...
        <table cellpadding="5">
                ...
                <td><input class="easyui-validatebox" type="text" name="name"
                        ...
                        <tr>
                <td>typesId:</td>
                <td><input class="easyui-validatebox" type="text" name="typesId"
                           data-options="required:true"></input></td>
            </tr>
                    </table>
    </form>
